...
:::note
Like any [instance template](/platform/instances#instance-templates), on-demand templates need the default `micro` [instance type](/platform/instances#instance-types).
QEMU-backed full VMs (`--type full`), which [GPU instances](/platform/instances#gpus) require, don't support them.
:::
