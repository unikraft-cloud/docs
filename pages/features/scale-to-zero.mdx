...
![Scale-to-zero request forwarding](/images/diagrams/stz-request.svg)

![Scale-to-zero wake-up chain](/images/diagrams/stz-ready-chain.svg)

![Scale-to-zero reply](/images/diagrams/stz-reply.svg)
