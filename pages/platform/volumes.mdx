...
{/* vale off */}
:::tip[Drive volumes from your own code]
The [SDKs](/sdks/overview) wrap the volume API, including attaching and detaching volumes:
...
When you create a volume template, the platform converts the source volume to a template.
